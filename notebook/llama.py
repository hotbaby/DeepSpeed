...
def stats_model_param_num(model: Transformer):
    ...
    print("embedding param num: ", module_param_num(model.tok_embeddings))
    print("layer param num: ", model_param_num(model.layers))
    print("out param num: ", model_param_num(model.output))
...
if __name__ == "__main__":
    ...
    print("calculate model param number ...")
    model_param_num = sum([p.numel() for p in llama_model.parameters()])
    print(model_param_num)